...
function App() {
  ...
  const claim =
    isValidAddress &&
    addresses.claims[
      ethers.utils.getAddress(input) as keyof typeof addresses.claims
    ];
  ...
  async function executeClaim() {
    try {
      ...
      const data = merkleDistributorInterface.encodeFunctionData(
        "claim",
        claimArgs
      );
    ...
    <div>
      ...
      <div className="claim-container">
        ...
        <p>
          ...
          <a href="https://medium.com/dappnode/dappnode-validator-nft-challenge-40e12748cf9b">
            Medium post
          </a>{" "}
